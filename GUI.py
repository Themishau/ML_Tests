...
from ml import load_img_data_and_resize_grey, load_img_data_and_resize_rgb, shuffle_training_data
from ml import prepare_training_data_np, normalize_model, train_model
from ml import save_model_training_data, load_normalized_model, load_trained_model, init_gpu
from ml import save_trained_model, save_normalized_model, load_model_training_data
from ml import layer_sizes, dense_layers, conv_layers, batch_size
from ml import prepare_images_to_test, load_trained_model_only
...
class View(Publisher, Subscriber):
    ...
    # four events (for grey and RGB imgs):
